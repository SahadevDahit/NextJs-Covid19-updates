...
const Countryrecord = ({ coviddata, styles }) => {
      ...
      try {
        const option = {
          ...
          headers: {
            ...
            "X-RapidAPI-Key":
              "5072ad6e0emshf9fdfafacff186ap1b7789jsn6b034a27e6f8",
          },
        };
        await axios
          .request(option)
  ...
  let sorted_Country = [...coviddata];
  sorted_Country.sort(function (a, b) {
      ...
      <div className={styles.countryrecord}>
        ...
        <div className="w-100 h-100 row d-flex">
          <div className="container-fluid p-5 col-xl-6 col-md-6 col-sm-flex-column ">
            ...
            <h5>
              Test_Percentage
              <span className="mx-2"> {coviddata[index].Test_Percentage}</span>
            </h5>
            <h5>
            ...
            <h5>
              NewCases <span className="mx-2">{coviddata[index].NewCases}</span>
            </h5>
            <h5>
              TotalDeaths{" "}
            ...
            <h5>
              Serious_Critical{" "}
              <span className="mx-2">{coviddata[index].Serious_Critical}</span>
            </h5>
            <h5>
              Tests_1M_Pop{" "}
            ...
            <h5>
              TotCases_1M_Pop{" "}
              <span className="mx-2"> {coviddata[index].TotCases_1M_Pop}</span>
            </h5>
          </div>
